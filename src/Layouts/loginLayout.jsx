            ...
            <main className="h-[8vh] bg-black flex ">
                ...
                <div className="p-2 flex gap-4">
                    <div className=" items-center">
                     ...
                     <div className=" bg-green-200 w-12 h-12 rounded-full overflow-hidden  text-center flex flex-col justify-center mt-1 hover:bg-green-400 hover:cursor-pointer">
